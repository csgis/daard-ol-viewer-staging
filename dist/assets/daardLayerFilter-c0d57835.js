import{m as u,g as h,e as m,s as y,r as F}from"./index-3482ff3a.js";import{f as v}from"./feather-becb2378.js";const b=function(r,e,t){return console.log(r,e,t),fetch(`${e}/wps?service=WPS&outputFormat=json`,{headers:{accept:"application/json","accept-language":"de-DE,de;q=0.5","content-type":"application/xml"},referrer:"https://geoserver.dainst.org/catalogue/",body:`
      ...
      `,method:"POST"}).then(o=>o.json()).catch(o=>{console.error("Error:",o)})};async function x(r){async function e(o,n){try{const a=await fetch(o,n);return a.ok?{success:!0,status:a.status}:{success:!1,status:a.status,error:"Response not OK"}}catch(a){return{success:!1,error:a.message}}}const t=await e(r,{method:"GET"}),s=await e(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({test:"data"})});return{getResult:t,postResult:s}}const I=()=>{let r=`
    <div 
